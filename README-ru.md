...
| Тип конфигурации           | Параметры                                                                                                                           | Совместимость с официальным клиентом |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| **Только мусорные пакеты** | `{"jc":4,"jmin":64,"jmax":256}`                                                                                                     | ✅ Совместимо                        |
| **Мусор + подписи**        | `{"jc":2,"jmin":64,"jmax":128,"i1":"<b 0xc0><r 16>"}`                                                                               | ✅ Совместимо                        |
| **Обфускация рукопожатия** | `{"s1":10,"s2":15,"h1":3946285740,"h2":1234567890,"h3":987654321,"h4":555666777}`                                                   | ❌ Требуется форк                    |
| **Полная обфускация**      | `{"jc":4,"jmin":64,"jmax":256,"s1":10,"s2":15,"h1":3946285740,"h2":1234567890,"h3":987654321,"h4":555666777,"i1":"<b 0xc0><r 32>"}` | ❌ Требуется форк                    |
